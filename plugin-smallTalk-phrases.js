...
var plugin_smallTalk_phrases = [
	...
	"There's a reason you can learn from everything: you have basic wisdom, basic intelligence, and basic goodness. ~ Pema Chödrön",
	...
	"Gloriousness and wretchedness need each other. One inspires us, the other softens us. ~ Pema Chödrön",
	...
	"If you are politically inclined, you may be President of the United States. ~ Barbara Jordan",
	...
	"It was on Alcatraz...where at long last some Native Americans, including me, truly began to regain our balance. ~ Wilma Mankiller",
	...
	"For a long time I have considered even the craziest ideas about atom nucleus... and suddenly I discovered the truth. ~ Maria Goeppert Mayer",
	...
	"I watched the faces of the listeners when the minister would cry out how much God loved them and how much they needed to set themselves right with God. They were faces without any argument in them, just tired faces that were glad to hear Somebody loved them. ~ Marilyn Monroe",
	...
	"What difference do it make if the thing you scared of is real or not?       (from ~ Toni Morrison",
	...
	"There is really nothing more to say -- except why. But since why is difficult to handle, one must take refuge in how. (from ~ Toni Morrison",
	...
	"[when asked whether she was still a lesbian] Are you still the alternative? ~ Martina Navratilova",
	...
	"I stand at the altar of the murdered men, and, while I live, I fight their cause. [1856] ~ Florence Nightingale",
	"Asceticism is the trifling of an enthusiast with his power, a puerile coquetting with his selfishness or his vanity, in the absence of any sufficiently great object to employ the first or overcome the last. [1857] ~ Florence Nightingale",
	"No man, not even a doctor, ever gives any other definition of what a nurse should be than this -- 'devoted and obedient.' This definition would do just as well for a porter. It might even do for a horse. It would not do for a policeman. [1859] ~ Florence Nightingale",
	...
	"To write is to descend, to excavate, to go underground. ~ Anaïs Nin",
	"I am in a beautiful prison from which I can only escape by writing. ~ Anaïs Nin",
	"My diary is a mirror telling the story of a dreamer who, a long long time ago went through life the way one reads a book. ~ Anaïs Nin",
	...
	"I have the right to love many people at once and to change my prince often. ~ Anaïs Nin",
	"What I cannot love, I overlook. ~ Anaïs Nin",
	"Dreams are necessary to life. ~ Anaïs Nin",
	"Dreams have helped me to live. ~ Anaïs Nin",
	"Eroticism is one of the basic means of self-knowledge, as indispensible as poetry. ~ Anaïs Nin",
	...
	"Jazz is the music of the body. ~ Anaïs Nin",
	"Don't let one cloud obliterate the whole sky. ~ Anaïs Nin",
	"Love never dies a natural death. It dies because we don't know how to replenish its source. It dies of blindness and errors and betrayals. It dies of illness and wounds; it dies of weariness, of witherings, of tarnishings. ~ Anaïs Nin",
	"I postpone death by living, by suffering, by error, by risking, by giving, by loving. ~ Anaïs Nin",
	...
	"If we continue the way we are going, market forces will not solve the pay gap until 2050. That means my youngest daughter's youngest daughter can expect equal pay. ~ Karen Nussbaum",
	"Every individual is capable of extraordinary things, but no one can accomplish anything by themselves. Working women should count, but the only way we'll make that true is if we work together. ~ Karen Nussbaum",
	...
	"It is women who primarily provide health care for their families, women who end up taking their kids to the doctor and caring for the other dependents in the family. I think that it's a day-to-day family management crisis for women in a bigger sense than it might be for men. ~ Karen Nussbaum",
	"If you can't afford child care, then you work a different schedule than your husband. ~ Karen Nussbaum",
	...
	"The inferiority of women is a hideous lie which has been enforced by law and woven into the British constitution. ~ Christabel Pankhurst",
	"We are here to claim our rights as women, not only to be free, but to fight for freedom. It is our privilege, as well as our pride and our joy, to take some part in this militant movement, which, as we believe, means the regeneration of all humanity. ~ Christabel Pankhurst",
	"Remember the dignity of your womanhood. Take courage, join hands, stand beside us, fight with us. ~ Christabel Pankhurst",
	"Where peaceful means had failed, one act of militancy succeeded and never again was the cause ignored by that or any other newspaper. ~ Christabel Pankhurst",
	"We are not ashamed of what we have done, because, when you have a great cause to fight for, the moment of greatest humiliation is the moment when the spirit is proudest. ~ Christabel Pankhurst",
	"Never lose your temper with the Press or the public is a major rule of political life. ~ Christabel Pankhurst",
	"Let us sink such differences as nationality, religion, politics, and set our eyes eternally and forever toward the rising star of the industrial republic of labor. ~ Lucy Parsons",
	...
	"You are not absolutely defenseless. For the torch of the incendiary, which has been known with impunity, cannot be wrested from you. ~ Lucy Parsons",
	...
	"Just as we fooled ourselves that the end of discriminatory laws would soon lead to racial harmony, so we thought that increased access to education, advancement and male-only arenas would erase the attitudes that have led some men to treat women like children, fools and punching bags. ~ Anna Quindlen",
	"I think women are superior to men. ~ Anna Quindlen",
	...
	"These trees don't make a forest. ~ Anna Quindlen",
	"The truth about your own life is not always easy to accept, and sometimes hasn't even occurred to you. ~ Anna Quindlen",
	"I think of a column as having a conversation with a person that it just so happens I can't see. ~ Anna Quindlen",
	"My only real political identification has been with women's rights. ~ Anna Quindlen",
	...
	"Only the deepest sense that they are not like us, that they do not love or live or hurt like us, makes it possible to decree, as [Newt] Gingrich has, that one way to reform the welfare system is to deny aid to the children of mothers under 21 and build orphanages if they are rendered destitute. ~ Anna Quindlen",
	...
	"My kids keep trying to convince me that there are two separate parts of their stomachs, one dedicated to dinner and the other to dessert. ~ Anna Quindlen",
	"Life on the planet is born of woman. ~ Adrienne Rich",
	"Women have been the truly active people in all cultures, without whom human society would long ago have perished, though our activity has most often been on the behalf of men and children. ~ Adrienne Rich",
	...
	"But to be a female human being trying to fulfill traditional female functions in a traditional way is in direct conflict with the subversive function of the imagination. ~ Adrienne Rich",
	"Lying is done with words and also with silence. ~ Adrienne Rich",
	"False history gets made all day, any day, ~ Adrienne Rich",
	...
	"There are days when housework seems the only outlet. ~ Adrienne Rich",
	"Sleeping, turning in turn like planets ~ Adrienne Rich",
	"The moment of change is the only poem. ~ Adrienne Rich",
	"You gain strength, courage, and confidence by every experience in which you really stop to look fear in the face. You must do the thing which you think you cannot do. ~ Eleanor Roosevelt",
	"No one can make you feel inferior without your consent. ~ Eleanor Roosevelt",
	"Remember always that you not only have the right to be an individual, you have an obligation to be one. ~ Eleanor Roosevelt",
	"The word ~ Eleanor Roosevelt",
	...
	"Greater understanding and practice of planned parenthood, through the use of contraceptive measures prescribed by doctors and clinics, will mean that there will be more strong and healthy children and fewer defective and handicapped babies unable to find a useful or happy place in life. ~ Margaret Sanger",
	...
	"Now one of two things is true: Either a republic is a desirable form of government, or else it is not. If it is, then we should have it, if it is not, then we ought not to pretend that we have it. ~ Anna Howard Shaw",
	...
	"Every serious dancer is driven by notions of perfection -- perfect expressiveness, perfect technique. of the intellectual upon art. ~ Susan Sontag",
	...
	"Whatever the theories may be of woman's dependence on man, in the supreme moments of her life he can not bear her burdens. (from \" ~ Elizabeth Cady Stanton",
	"Nature never repeats herself, and the possibilities of one human soul will never be found in another. (from \" ~ Elizabeth Cady Stanton",
	...
	"Men say we are ever cruel to each other. Let us end this ignoble record and henceforth stand by womanhood. If Victoria Woodhull must be crucified, let men drive the spikes and plait the crown of thorns. ~ Elizabeth Cady Stanton",
	"So long as women are slaves, men will be knaves. ~ Elizabeth Cady Stanton",
	"It would be ridiculous to talk of male and female atmospheres, male and female springs or rains, male and female sunshine . . . . how much more ridiculous is it in relation to mind, to soul, to thought, where there is as undeniably no such thing as sex, to talk of male and female education and of male and female schools. ~ Elizabeth Cady Stanton",
	"To throw obstacles in the way of a complete education is like putting out the eyes. ~ Elizabeth Cady Stanton",
	"The prejudice against color, of which we hear so much, is no stronger than that against sex. It is produced by the same cause, and manifested very much in the same way. The negro's skin and the woman's sex are both ~ Elizabeth Cady Stanton",
	...
	"As a colored woman I may enter more than one white church in Washington without receiving that welcome which as a human being I have the right to expect in the sanctuary of God. ~ Mary Church Terrell",
	...
	"Printer's ink was in my veins, I decided, and I became dedicated to the proposition that this was the life for me ~ Helen Thomas",
	"I was so lucky to pick a profession where it's a joy to go to work every day. ~ Helen Thomas",
	...
	"Reporters see so much more than anyone else, really, if they open their eyes. It's their job to take a very human approach. I don't see how you can see what's all around you and not be liberal. You see the poor. You see the hungry. You see the suffering. ~ Helen Thomas",
	"We were raised not only to do something with our lives but be somebody, even us girls, uncommon as that thinking was in those days. ~ Helen Thomas",
	...
	"[Reporters] are not there to curry presidential favor, nor can we respond to efforts at presidential intimidation. Our priority is the peoples' right to know -- without fear or favor. We are the peoples' servants. ~ Helen Thomas",
	"When it comes to the Presidential news conference, I have never lost my sense of awe that I am able to quiz a President of the United States -- politely I hope, but if necessary to hold his feet to the fire. ~ Helen Thomas",
	"Thank you Mister President.  [ ~ Helen Thomas",
	...
	"There was no way he could save himself. It was like a Greek tragedy. ~ Helen Thomas",
	"All of us who covered the Reagans agreed that President Reagan was personable and charming. But I'm not so certain he was nice. ~ Helen Thomas",
	...
	"It should be mandatory that every president would read the Constitution. Too many swear to uphold the Constitution and then make end runs around it. ~ Helen Thomas",
	"This administration in particular has chipped away at the Bill of Rights while the people were numbed by the trauma of 9/11, and we let them get away with it. Not only the people at large but the Congress has been willing to abridge our rights through the PATRIOT Act, a terrific infringement of our privacy. ~ Helen Thomas",
	...
	"I told the young leaders that the 21st Century is theirs and they should not blow it. Try to reject war and give peace a chance. Question the powers that be and find out why they make the dubious decisions they do that send young people to war. ~ Helen Thomas",
	...
	"To start a new century with a war, what can young people think? ~ Helen Thomas",
	"Who ever plans on falling in love? I certainly didn't have a two-track mind back then when I first started covering the White House. I didn't think it was possible to do the kind of work I loved to do and still be a wife.... How wrong -- and how lucky -- I was. ~ Helen Thomas",
	"I always wondered why somebody doesn't do something about that. Then I realized I was somebody. ~ Lily Tomlin",
	"Success is a ladder that cannot be climbed with your hands in your pocket. ~ Lily Tomlin",
	...
	"I had reasoned this out in my mind, there was one of two things I had a ~ Harriet Tubman",
	...
	"We went overboard on management and forgot about leadership. It might help if we ran the MBAs out of Washington. ~ Grace Hopper",
	...
	"The surest guide to the correctness of the path that women take is joy in the struggle. ~ Germaine Greer",
	...
	"For a male child to become a man, he has to reject his mother. It's an essential part of masculinisation. ~ Germaine Greer",
	...
	"I would say our greatest achievement is to have survived as a free and democratic nation. ~ Indira Gandhi",
	"I don't mind if my life goes in the service of the nation. If I die today every drop of my blood will invigorate the nation. (said the night before she was assassinated) ~ Indira Gandhi",
	...
	"You have to learn to love yourself before you can love me or accept my loving. Know we are worthy of touch before we can reach out for each other. Not cover that sense of worthlessness with \"I don't want you\" or \"it doesn't matter\" or \"white folks feel, Black folks do.\" ~ Audre Lorde",
	...
	"In a standardized world she kept her own individuality, her own atmosphere, an oasis of peace and quiet in a world grown increasingly shrill. ~ Eleanor Roosevelt"
];